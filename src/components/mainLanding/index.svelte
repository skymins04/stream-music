<script lang="ts">
  ...
  handleCredentialResponse = googleLoginHandler;

  let counter = 0;
  const interval = setInterval(() => {
    if (counter >= 100000) clearInterval(interval);
    const ele = document.getElementById("credential_picker_container");
    if (ele) {
      setTimeout(() => {
...
<Protector>
  <div id="mainlanding-page">
    <ToastContainer let:data>
      <FlatToast {data} />
    </ToastContainer>

    <div class:displaynone={!$FlagLoginDialog}>
      <Popup popupFlag={FlagLoginDialog} width={"50%"} minWidth={"300px"}>
        <div class="popup-title">로그인</div>
        <div
          id="g_id_onload"
          data-client_id="470730308122-3b17qe38pshbfnicl3bl08s10isv2581.apps.googleusercontent.com"
      ...
      <div class="viewport">
        <div class="header">
          ...
          <div class="header-right">
            <MediaQuery query="(min-width: 710px)" let:matches>
              {#if matches}
                <a
                  on:click={() =>
        ...
        <div class="article">
          ...
          <div class="section" id="ABOUT">
            ...
            <MediaQuery query="(min-width: 710px)" let:matches>
              <div class="grid" class:display-flex-colume={!matches}>
                <div class="item">
                  <svg
                    class="icon"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="item">
                  ...
                  <p>
                    <span class="bold">YouTube음원와 로컬파일음원</span>(MP3,
                    WAV, FLAC)
                    <span class="bold">으로 플레이리스트를 구성하고 재생</span
                    >할 수 있으며, 파일로 내보내거나 가져올 수 있습니다.
                  </p>
                </div>
                <div class="item">
                  <svg
